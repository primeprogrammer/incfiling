...
<span style="color:white;font-size:25px;border-bottom:2px solid white;">LIMITED LIABILITY PARTNERSHIP</span><br><br>

<span style="color:white;font-size:25px;">Limited Liability Partnership (LLP) offer limited liability protection for an association of persons doing business. LLP is ideal for small businesses. INCFilings offers LLP registration from Rs.7899/-
</span>
</div>
...
<h4 style="color:white;padding-top:2%;">Limited Liability Partnership</h4>
</div>
<br><br><br><br>
