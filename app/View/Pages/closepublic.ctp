...
<span style="color:white;font-size:25px;border-bottom:2px solid white;">CLOSE PUBLIC LIMITED COMPANY</span><br><br>
...
<h4 style="color:white;padding-top:2%;">Close Public Limited Company</h4>
</div>
<br><br><br><br>
