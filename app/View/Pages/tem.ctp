...
<span style="color:white;font-size:25px;border-bottom:2px solid white;">TEMPORARY GST REGISTRATION</span><br><br>

<span style="color:white;font-size:25px;">GST registration is mandatory for all entities involved in the buying or selling or providing of services in India. IndiaFilings offers an easy process for obtaining GST Registration from Rs.2899/-
.
</span>
</div>
...
<h4 style="color:white;padding-top:2%;">Temporary GST Registration</h4>
</div>
<br><br><br><br>
