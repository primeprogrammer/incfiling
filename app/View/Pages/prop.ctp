...
<span style="color:white;font-size:25px;border-bottom:2px solid white;">PROPRIETORSHIP</span><br><br>

<span style="color:white;font-size:25px;">Proprietorship is an alias for the Proprietor to do business. Proprietorships are ideal for very small businesses in the unorganised sector. INCFilings offers proprietorship registration from Rs.2899/-
</span>
</div>
...
<h4 style="color:white;padding-top:2%;">Proprietorship</h4>
</div>
<br><br><br><br>
