...
<span style="color:white;font-size:25px;border-bottom:2px solid white;">TRADEMARK RECTIFICATION</span><br><br>

<span style="color:white;font-size:25px;">During the trademark registration process, an application can be marked as formalities chk fail by the Trademark Examiner. INCFilings offers an easy process for rectifying the application from Rs.5899/-
.
</span>
</div>
...
<h4 style="color:white;padding-top:2%;">Trademark Rectification</h4>
</div>
<br><br><br><br>
