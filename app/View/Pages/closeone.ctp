...
<span style="color:white;font-size:25px;border-bottom:2px solid white;">CLOSE ONE PERSON COMPANY</span><br><br>

<span style="color:white;font-size:25px;">Transforming Ideas Into Greatness
Winding Up One Persone Company.
</span>
</div>
...
<h4 style="color:white;padding-top:2%;">Close One Person Company</h4>
</div>
<br><br><br><br>
