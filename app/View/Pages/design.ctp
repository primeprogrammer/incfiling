...
<span style="color:white;font-size:25px;border-bottom:2px solid white;">DESIGN REGISTRATION</span><br><br>

<span style="color:white;font-size:25px;">Design registration can be used to protect original shapes, patterns, ornaments, and composition of colours and lines applied to any article by an industrial process. INCFilings offers an easy process for obtaining design registration from Rs.7899/-
...
<h4 style="color:white;padding-top:2%;">Design Registration</h4>
</div>
<br><br><br><br>
