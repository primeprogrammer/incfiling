...
<span style="color:white;font-size:25px;border-bottom:2px solid white;">ONE PERSON COMPANY</span><br><br>

<span style="color:white;font-size:25px;">One Person Company is a new type of business entity that allows a single entrepreneur to operate a corporate entity with limited liability protection.
</span>
</div>
...
<h4 style="color:white;padding-top:2%;">One Persone Company</h4>
</div>
<br><br><br><br>
