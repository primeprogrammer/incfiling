...
<span style="color:white;font-size:25px;border-bottom:2px solid white;">TRADEMARK OBJECTION</span><br><br>
<span style="color:white;font-size:25px;">During the trademark registration process, an objection can be raised by the Trademark Examiner. INCFilings offers an easy process for responding to trademark objections from Rs.2899/-
</span>
</div>
...
<h4 style="color:white;padding-top:2%;">Trademark Objection</h4>
</div>
<br><br><br><br>
