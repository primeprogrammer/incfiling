...
<span style="color:white;font-size:25px;border-bottom:2px solid white;">MSME REGISTRATION</span><br><br>

<span style="color:white;font-size:25px;">MSME registration is required for micro, small and medium sized enterprises to avail various incentives provided under the MSMED Act.
</span>
</div>
...
<h4 style="color:white;padding-top:2%;">MSME Registration</h4>
</div>
<br><br><br><br>
